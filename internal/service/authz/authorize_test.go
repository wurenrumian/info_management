...
func TestAuthorizeMatrix(t *testing.T) {
	cases := []struct {
		...
		{model.RoleCadre, authz.ActionApprovalsCreate, true},
		{model.RoleCadre, authz.ActionApprovalsReview, false},
		...
		{model.RoleTeacher, authz.ActionApprovalsCreate, true},
		{model.RoleTeacher, authz.ActionApprovalsReview, true},
